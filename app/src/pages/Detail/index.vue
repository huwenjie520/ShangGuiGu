          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(saleAttr, index) in spuSaleAttrList" :key="saleAttr.id">
                ...
                <dd changepirce="0" :class="{'active': saleAttrValue.isChecked==='1'}" v-for="(saleAttrValue, index) in saleAttr.spuSaleAttrValueList" :key="saleAttrValue.id" @click="changeCurrentIndex(saleAttr, saleAttrValue)">{{ saleAttrValue.saleAttrValueName }}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
...
<script>
  ...
  export default {
    ...
    methods: {
      changeCurrentIndex(saleAttr, saleAttrValue) {
        // 排他操作，先把所有的置为0，再把选中的置为1
